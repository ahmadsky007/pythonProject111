...
Original file is located at
    https://colab.research.google.com/drive/1xXwEo3gbTGJrVtvE1QFjKpJXN7LvDYDQ
...
# Create and print a sentence with the collected information
print("Your full name is " + name + " " + surname + " and you are " + age + " years old.")
...
# Determine the grade in the Polish system
if score >= 90:
    grade = 5
elif score >= 75:
    grade = 4
...
if number2 == 0:
    ...
    # Check if the first number can be evenly divided by the second
    if number1 % number2 == 0:
        result = "can be evenly divided"
    else:
        result = "cannot be evenly divided"

    # Print the result
    print(f"The first number {result} by the second.")
...
if side1 + side2 > side3 and side1 + side3 > side2 and side2 + side3 > side1:
    # If a triangle can be formed, check the type of triangle
    if side1 == side2 == side3:
        triangle_type = "Equilateral"
    elif side1 == side2 or side1 == side3 or side2 == side3:
        triangle_type = "Isosceles"
